...
<?php if ( bp_has_groups( bp_ajax_querystring( 'groups' ) ) ) : ?>
	...
	<ul id="groups-list" class="child-template <?php bp_nouveau_loop_classes(); ?> <?php echo $cover_class; ?>">
		...
		<li <?php bp_group_class( array( 'item-entry' ) ); ?> data-bp-item-id="<?php bp_group_id(); ?>" data-bp-item-component="groups">
			<div class="list-wrap">
				...
				<?php if( !bp_disable_group_cover_image_uploads() ) { ?>
					...
					?>
					<div class="bs-group-cover only-grid-view"><a href="<?php bp_group_permalink(); ?>activity"><img src="<?php echo $group_cover_image_url; ?>"></a></div>
				<?php } ?>

				<?php if ( ! bp_disable_group_avatar_uploads() ) : ?>
					<div class="item-avatar">
						<a href="<?php bp_group_permalink(); ?>activity" class="group-avatar-wrap"><?php bp_group_avatar( bp_nouveau_avatar_args() ); ?></a>
