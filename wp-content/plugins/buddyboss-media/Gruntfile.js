...
module.exports = function ( grunt ) {
    ...
    grunt.initConfig( {
        ...
        uglify: {
            ...
            frontend: {
                files: {
                    ...
                    'assets/js/buddyboss-media-nouveau.min.js': [ 'assets/js/buddyboss-media-nouveau.js' ],
        ...
        checktextdomain: {
            options: {
                text_domain: [ 'buddyboss-media', 'buddypress', 'bbpress', 'buddypress-inbox', 'buddyboss-media', 'buddyboss-welcome-experience', 'buddypress-edit-activity' ], //Specify allowed domain(s)
