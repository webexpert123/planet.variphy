...
if ( ! defined( 'BUDDYBOSS_MEDIA_PLUGIN_VERSION' ) ) {
  define( 'BUDDYBOSS_MEDIA_PLUGIN_VERSION', '3.2.9' );
}
...
function buddyboss_media_install_buddypress_notice() {
	...
	_e('<strong>BuddyBoss Media</strong></a> requires the BuddyPress plugin to work. Please <a href="http://buddypress.org">install BuddyPress</a> first.', 'buddyboss-media');
	echo '</p></div>';
}
