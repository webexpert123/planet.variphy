...
class BuddyBoss_Media_Plugin
{
	...
	private function setup_actions()
	{
		...
		add_action( 'wp_footer', array( $this, 'bbm_photoswipe_gallery_html' ) );
	}

	public function bbm_photoswipe_gallery_html() {
	    ?>
            ...
            <div class="pswp__scroll-wrap">
                ...
                <div class="pswp__ui pswp__ui--hidden">
                    ...
                    <div class="pswp__top-bar">
                        ...
                        <button class="pswp__button pswp__button--close" title="<?php esc_attr_e( 'Close (Esc)', 'buddyboss-media' ); ?>"></button>

                        <button class="pswp__button pswp__button--share" title="<?php esc_attr_e( 'Share', 'buddyboss-media' ); ?>"></button>

                        <button class="pswp__button pswp__button--fs" title="<?php esc_attr_e( 'Toggle fullscreen', 'buddyboss-media' ); ?>"></button>

                        <button class="pswp__button pswp__button--zoom" title="<?php esc_attr_e( 'Zoom in/out', 'buddyboss-media' ); ?>"></button>

                        <button class="pswp__button pswp__button--favorite" title="<?php esc_attr_e( 'Favorite', 'buddyboss-media' ); ?>"><div class="ps-toolbar-favorite"><div class="ps-toolbar-content"></div><div class="ps-favorite-count"></div></div></button>
                        <button class="pswp__button pswp__button--comment" title="<?php esc_attr_e( 'Comment', 'buddyboss-media' ); ?>"><div class="ps-toolbar-comment"><div class="ps-toolbar-content"></div><div class="ps-comment-count"></div></div></button>
                        <button class="pswp__button pswp__button--delete" title="<?php esc_attr_e( 'Delete', 'buddyboss-media' ); ?>"><?php _e( 'Delete', 'buddyboss-media' ); ?></button>
                    ...
                    <button class="pswp__button pswp__button--arrow--left" title="<?php esc_attr_e( 'Previous (arrow left)', 'buddyboss-media' ); ?>">
                    </button>

                    <button class="pswp__button pswp__button--arrow--right" title="<?php esc_attr_e( 'Next (arrow right)', 'buddyboss-media' ); ?>">
                    </button>
