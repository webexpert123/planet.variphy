    ...
    public function script_templates() {
        ...
        <script type="text/html" id="buddyboss-comment-media-tpl-add-photo">
            <div class="buddyboss-comment-media-add-photo">
                ...
                <button class="open-uploader-button buddyboss-comment-media-add-photo-button" data-fancybox data-src="#buddyboss-comment-media-bulk-uploader-wrapper" style="<?php echo ( ! empty( $show_uploadbox ) ) ? 'display:none;' : ''; ?>"></button>
