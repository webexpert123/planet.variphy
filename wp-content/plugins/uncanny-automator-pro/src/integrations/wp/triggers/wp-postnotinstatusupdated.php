...
class WP_POSTNOTINSTATUSUPDATED {
	...
	public function define_trigger() {
		...
		$trigger = array(
			...
			'sentence'            => sprintf( __( 'A user updates a post not in {{a specific:%1$s}} status', 'uncanny-automator-pro' ), $this->trigger_meta ),
			/* translators: Logged-in trigger - WordPress Core */
			'select_option_name'  => __( 'A user updates a post not in {{a specific}} status', 'uncanny-automator-pro' ),
			'action'              => 'post_updated',
			'priority'            => 10,
			'accepted_args'       => 3,
