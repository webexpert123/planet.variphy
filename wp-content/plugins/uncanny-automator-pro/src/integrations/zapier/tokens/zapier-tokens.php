...
class Zapier_Tokens {
	...
	public function __construct() {
		...
		add_filter( 'automator_maybe_parse_token', [ $this, 'parse_zapier_token' ], 20, 6 );
	}
	 ...
	 * @return mixed
	 */
	public function parse_zapier_token( $value, $pieces, $recipe_id, $trigger_data, $user_id, $replace_args ) {
		$piece = 'ANON_ZAPIERWEBHOOKS';
		if ( $pieces ) {
