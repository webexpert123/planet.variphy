				...
				<form class="uo-license-content-form" method="POST">
					...
					<div class="uo-license-content-footer">
						...
						<?php } else { ?>
							...
							<?php if ( strlen( $license ) ) { ?>
								<a href="<?php echo admin_url( 'edit.php?post_type=uo-recipe&page=uncanny-automator-license-activation&clear_license_field=1' ) ?>"
								   class="uo-license-btn--secondary">
									<?php _e( 'Clear field', 'uncanny-automator-pro' ); ?>
								</a>
							<?php } ?>
						<?php } ?>
