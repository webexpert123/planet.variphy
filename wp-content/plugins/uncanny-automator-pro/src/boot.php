...
class Boot {
	...
	public function __construct() {
		...
		if ( file_exists( __DIR__ . '/libraries/woocommerce/action-scheduler/action-scheduler.php' ) ) {
			include_once __DIR__ . '/libraries/woocommerce/action-scheduler/action-scheduler.php';
		}
	...
	public function automator_free_version_check() {
		if ( defined( 'AUTOMATOR_PLUGIN_VERSION' ) && version_compare( AUTOMATOR_PLUGIN_VERSION, '3.1', '<' ) ) {
			...
			$message = sprintf(
				...
				sprintf( __( 'Please %s to ensure your recipes continue to run.', 'uncanny-automator-pro' ),
