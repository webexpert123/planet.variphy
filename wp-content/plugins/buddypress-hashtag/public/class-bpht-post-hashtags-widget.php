    ...
    public function widget( $args, $instance ) {
        ...
        <div>
            ...
            if($wpdb->get_var("SHOW TABLES LIKE '$table_name'")) {
                $_hashtags = $wpdb->get_results("SELECT * FROM $table_name WHERE ht_type IN ('post') ORDER BY ht_count DESC LIMIT $limit");
                if( $_hashtags ) {
                    ...
                    <div class="bpht-widget--hashtags">
                        <div class="bpht-hashtags-wrapper <?php echo $wrapper;?>">
                            ...
                            foreach($hashtags as $name => $hash_data) {
                                ...
                                echo ' <a href="'. $site_url . '?s=%23' . htmlspecialchars( $name ) . '" rel="nofollow" class="hashtag" id="' . htmlspecialchars( $name ) . '">#'. htmlspecialchars( $name ) .'</a>';
                                echo '</div>';
                            }
                            ?>
                        </div>
