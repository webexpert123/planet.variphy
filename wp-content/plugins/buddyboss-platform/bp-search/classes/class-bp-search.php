...
$kbs = $_REQUEST["search_term"];
//First 100 Posts
$htkb_posts_req = wp_remote_get( 'https://kb.variphy.com/wp-json/wp/v2/ht-kb?search='.$kbs.'&per_page=5&page=1');
...
//Next 100 Posts
$htkb_posts_req2 = wp_remote_get( 'https://kb.variphy.com/wp-json/wp/v2/ht-kb?search='.$kbs.'&per_page=5&page=2');
...
$total_found_posts = $loop->found_posts;
		...
		// 						$knowledgeBase  = array(
		// 							'value'      => "<div class='bp-search-ajax-item bp-search-ajax-item_topic'><div class='knowledge-base'><div class='item-avatar' style='    float: left;'>
		// 	<img src='".site_url()."/wp-content/uploads/2021/07/kb-icon.png' class='avatar forum-avatar' height='150' width='150' alt=''>
		// </div><a href='" . esc_url( $post->link ) . "'>" . __( ''.$post->title->rendered.'', 'buddyboss' ) . '</a></div></div>',
		// 							'type'       => 'topic_type',
		// 							'type_label' => '',
		// 						);
		// 						$search_results[] = $knowledgeBase;



									$search_results[]= '<li class="bbls-topic-type knowledge-base-suggetion bbls-sub-item ui-menu-item"><a class="x ui-menu-item-wrapper" id="ui-id-39" tabindex="-1"></a><div class="bp-search-ajax-item bp-search-ajax-item_topic ui-menu-item-wrapper" id="ui-id-40" tabindex="-1"><a class="x"> </a><a href="'. esc_url( $post->link ) . '"> <div class="item-avatar"> <img src="'.site_url().'/wp-content/uploads/2021/07/kb-icon.png" class="avatar forum-avatar" height="150" width="150" alt=""> </div> <div class="item"> <div class="item-title"> '.$post->title->rendered.'</div>  </div> </a> </div> </li>';
								...
								$spacerDiv  = array(
									'value'      => '<div class=" spacer-div" style="margin-top:20px !important;"></div>',
									'type'       => 'view_all_type',
									'type_label' => '',
								);
								$search_results[] = $spacerDiv;
		...
		public function print_tabs() {
         ...
         if($_SESSION['kb_total_count'] > 0){
            $knowledgeBase = ob_start();
         	?>
			...
			<div class="additional-search">
				...
				<p class=" knowledge-base" data-item="knowledge-base">
					...
					<a class="knowledge-base-link" href="<?php echo $knowledge_url;?>">Knowledge Base 
						<?php if($_SESSION['kb_total_count'] > 0){ ?>
						<span class="count"><?php echo $_SESSION['kb_total_count'];?></span>
						<?php } ?>
					</a>
				</p>
			</div>
